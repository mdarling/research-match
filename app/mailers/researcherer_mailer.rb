class ResearchererMailer < ActionMailer::Base
  ...
  def matched_students_notification(research_user, student_matches)
    ...
    first_name = research_user.first_name(0,1).capitalize + research_user.first_name.slice(1..-1)
    last_name = research_user.last_name(0,1).capitalize + research_user.last_name.slice(1..-1)
