ugp = UndergradProgram.where(:name=>'Biochemistry', :degree => 'BS')[0]
...
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'BIOC 448L: Biochemical Methods',
:credits =>3,
:min_grade => 'C',
:crucial =>false)
...
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'BIOC 451 OR CHEM 312: Physical Chemistry',
:credits =>4,
:min_grade => 'C',
:crucial =>false)
...
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'BIOC 497: Senior Honors Research OR BIOC 498: Senior Honors Research',
:credits =>3,
:min_grade => 'C',
:crucial =>false)

#Elective any level Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
...
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'BIOC 499: Undergraduate Research',
:credits =>3,
:min_grade => 'C',
:crucial =>false)
...
c34 = Course.where(:number => 'BIOC 448L', :dept_id => Dept.where(:acronym => 'BIOC')[0].id)[0]
c34.degree_requirements << DegreeRequirement.where(:name => 'BIOC 448L: Biochemical Methods', :academic_program_id => ugp.id)

c35 = Course.where(:number => 'BIOC 451', :dept_id => Dept.where(:acronym => 'BIOC')[0].id)[0]
c35.degree_requirements << DegreeRequirement.where(:name => 'BIOC 451 OR CHEM 312: Physical Chemistry', :academic_program_id => ugp.id)

c36 = Course.where(:number => 'CHEM 312', :dept_id => Dept.where(:acronym => 'CHEM')[0].id)[0]
c36.degree_requirements << DegreeRequirement.where(:name => 'BIOC 451 OR CHEM 312: Physical Chemistry', :academic_program_id => ugp.id)

c37 = Course.where(:number => 'BIOC 497', :dept_id => Dept.where(:acronym => 'BIOC')[0].id)[0]
c37.degree_requirements << DegreeRequirement.where(:name => 'BIOC 497: Senior Honors Research OR BIOC 498: Senior Honors Research', :academic_program_id => ugp.id)

c38 = Course.where(:number => 'BIOC 498', :dept_id => Dept.where(:acronym => 'BIOC')[0].id)[0]
c38.degree_requirements << DegreeRequirement.where(:name => 'BIOC 497: Senior Honors Research OR BIOC 498: Senior Honors Research', :academic_program_id => ugp.id)

c39 = Course.where(:number => 'BIOC 499', :dept_id => Dept.where(:acronym => 'BIOC')[0].id)[0]
c39.degree_requirements << DegreeRequirement.where(:name => 'BIOC 499: Undergraduate Research', :academic_program_id => ugp.id)
...
t6.degree_requirements << DegreeRequirement.where(:name => 'BIOC 448L: Biochemical Methods', :academic_program_id => ugp.id,:credits=>3)

t6.degree_requirements << DegreeRequirement.where(:name => 'BIOC 451 OR CHEM 312: Physical Chemistry', :academic_program_id => ugp.id,:credits=>4)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'BIOC 497: Senior Honors Research OR BIOC 498: Senior Honors Research', :academic_program_id => ugp.id,:credits=>3)
...
t8.degree_requirements << DegreeRequirement.where(:name => 'BIOC 499: Undergraduate Research', :academic_program_id => ugp.id,:credits=>3)
