ugp = UndergradProgram.where(:name=>'Mathematics (Pure Concentration)', :degree => 'BS')[0]
...
#Course:MATH 313: Complex Variables Term:4
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MATH 313: Complex Variables',
:credits =>3,
:min_grade => 'C',
:crucial =>false)
...
#Course:MATH 401: Advanced Calculus I Term:5
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:MATH 402: Advanced Calculus I Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MATH 402: Advanced Calculus I',
:credits =>3,
:min_grade => 'C',
:crucial =>false)


#Course:MATH 412: Nonlinear Dynamics and Chaos Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MATH 412: Nonlinear Dynamics and Chaos',
:credits =>3,
:min_grade => 'C',
:crucial =>false)


#Course:Elective Any Level Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'Elective Any Level',
:credits =>1,
:min_grade => 'D-',
...
#Course:MATH 322: Modern Algebra I Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
...
# Id of Mathema#Course:2nd Major or Upper-Division Elective Term:8
...
c8 = Course.where(:number => 'MATH 327', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c8.degree_requirements << DegreeRequirement.where(:name => 'MATH 327: Discrete Structures',:academic_program_id => ugp.id)
...
c14.degree_requirements << DegreeRequirement.where(:name => 'MATH 313: Complex Variables',:academic_program_id => ugp.id)

c15 = Course.where(:number => 'MATH 401', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c15.degree_requirements << DegreeRequirement.where(:name => 'MATH 401: Advanced Calculus I',:academic_program_id => ugp.id)

c16 = Course.where(:number => 'MATH 402', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c16.degree_requirements << DegreeRequirement.where(:name => 'MATH 402: Advanced Calculus I',:academic_program_id => ugp.id)

c17 = Course.where(:number => 'MATH 412', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c17.degree_requirements << DegreeRequirement.where(:name => 'MATH 412: Nonlinear Dynamics and Chaos',:academic_program_id => ugp.id)

c18 = Course.where(:number => 'MATH 322', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c18.degree_requirements << DegreeRequirement.where(:name => 'MATH 322: Modern Algebra I',:academic_program_id => ugp.id)

c22 = Course.where(:number => 'MATH 319', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c22.degree_requirements << DegreeRequirement.where(:name => '2nd Major or Upper-Division Elective',:academic_program_id => ugp.id)

c23 = Course.where(:number => 'MATH 421', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c23.degree_requirements << DegreeRequirement.where(:name => '2nd Major or Upper-Division Elective',:academic_program_id => ugp.id)

c24 = Course.where(:number => 'MATH 431', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c24.degree_requirements << DegreeRequirement.where(:name => '2nd Major or Upper-Division Elective',:academic_program_id => ugp.id)

c25 = Course.where(:number => 'MATH 434', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c25.degree_requirements << DegreeRequirement.where(:name => '2nd Major or Upper-Division Elective',:academic_program_id => ugp.id)

c26 = Course.where(:number => 'MATH 441', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c26.degree_requirements << DegreeRequirement.where(:name => '2nd Major or Upper-Division Elective',:academic_program_id => ugp.id)

c27 = Course.where(:number => 'MATH 462', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c27.degree_requirements << DegreeRequirement.where(:name => '2nd Major or Upper-Division Elective',:academic_program_id => ugp.id)

c28 = Course.where(:number => 'MATH 472', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c28.degree_requirements << DegreeRequirement.where(:name => '2nd Major or Upper-Division Elective',:academic_program_id => ugp.id)
...
t4.degree_requirements << DegreeRequirement.where(:name => 'MATH 313: Complex Variables',:academic_program_id => ugp.id,:credits=>3)
...
t5.degree_requirements << DegreeRequirement.where(:name => 'MATH 401: Advanced Calculus I',:academic_program_id => ugp.id,:credits=>3)

t5.degree_requirements << DegreeRequirement.where(:name => 'MATH Elective',:academic_program_id => ugp.id,:credits=>3)
...
t6.degree_requirements << DegreeRequirement.where(:name => 'MATH 402: Advanced Calculus I',:academic_program_id => ugp.id,:credits=>3)

t6.degree_requirements << DegreeRequirement.where(:name => 'MATH 412: Nonlinear Dynamics and Chaos',:academic_program_id => ugp.id,:credits=>3)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'MATH 322: Modern Algebra I',:academic_program_id => ugp.id,:credits=>3)
...
t8.degree_requirements << DegreeRequirement.where(:name => 'MATH Elective',:academic_program_id => ugp.id,:credits=>3)
