## BA Philosophy academic year 2013-2014
ugp = UndergradProgram.where(:name=>'Philosophy', :degree => 'BA')[0]
DegreePlan.create(:undergrad_program_id => ugp.id, :academic_year=>'2013-14')

# Degree Requirements for Term 1

# BA Philosophy academic year 2013-2014, Philosophy
...
# BA Philosophy academic year 2013-2014, ENGL 101
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Philosophy academic year 2013-2014, Freshman Academic Choice
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Philosophy academic year 2013-2014, MATH
DegreeRequirement.create(
	:academic_program_id => ugp.id,
	:name => 'MATH',
	:credits => 3,
...
# BA Philosophy year 2013-2014, Second Language
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Philosophy academic year 2013-2014, ENGL 102
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Philosophy academic year 2013-2014, Physical and Natural Science
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Philosophy academic year 2013-2014, Minor requirement or 2nd Major requirement
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Philosophy academic year 2013-2014, Elective
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Philosophy academic year 2013-2014, CJ 130/PHIL 156/ENGL 219/ENGL 220
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Philosophy academic year 2013-2014, Social Behavioral Science
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Philosophy academic year 2013-2014, Humanities
DegreeRequirement.create(
	:academic_program_id => ugp.id,
	:name => 'Humanities',
	:credits => 3,
...
# BA Philosophy academic year 2013-2014, Fine Arts
DegreeRequirement.create(
	:academic_program_id => ugp.id,
	:name => 'Fine Arts',
	:credits => 3,
...
# BA Philosophy academic year 2013-2014, Upper Division Elective
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Philosophy academic year 2013-2014, Elective any level
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Philosophy academic year 2013-2014, 2nd Major or Elective any level	
DegreeRequirement.create(
  :academic_program_id => ugp.id,
...
# BA Philosophy academic year 2013-2014, 2nd Major or Upper Division Elective	
DegreeRequirement.create(
  :academic_program_id => ugp.id,
...
# Id of the BA Philosophy Curriculum for academic year 2013-2014
...
# BA Philosophy Term 1
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 1)

# BA Philosophy Term 2
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 2)

# BA Philosophy Term 3
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 3)

# BA Philosophy Term 4
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 4)

# BA Philosophy Term 5
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 5)

# BA Philosophy Term 6
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 6)

# BA Philosophy Term 7
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 7)

# BA Philosophy Term 8
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 8)
...
t1.degree_requirements << DegreeRequirement.where(:name => 'Philosophy', :academic_program_id => ugp.id, :credits=>3)
...
t2.degree_requirements << DegreeRequirement.where(:name => 'Philosophy', :academic_program_id => ugp.id, :credits=>3)
...
t3.degree_requirements << DegreeRequirement.where(:name => 'Philosophy', :academic_program_id => ugp.id, :credits=>6 )
...
t4.degree_requirements << DegreeRequirement.where(:name => 'Philosophy', :academic_program_id => ugp.id, :credits=>9)
...
t5.degree_requirements << DegreeRequirement.where(:name => 'Philosophy', :academic_program_id => ugp.id, :credits=>6)
...
t6.degree_requirements << DegreeRequirement.where(:name => 'Philosophy', :academic_program_id => ugp.id, :credits=>6)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'Philosophy', :academic_program_id => ugp.id, :credits=>3)
...
t8.degree_requirements << DegreeRequirement.where(:name => 'Philosophy', :academic_program_id => ugp.id, :credits=>3)
