## BA Psychology academic year 2013-2014
ugp = UndergradProgram.where(:name=>'Psychology', :degree => 'BA')[0]
DegreePlan.create(:undergrad_program_id => ugp.id, :academic_year=>'2013-14')

# Degree Requirements for Term 1

# BA Psychology academic year 2013-2014, PSY 105
...
# BA Psychology academic year 2013-2014, ENGL 101
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology academic year 2013-2014, Freshman Academic Choice
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology academic year 2013-2014, MATH 121/ MATH 129/ STAT 145
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology year 2013-2014, Second Language
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology academic year 2013-2014, PSY 200
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology academic year 2013-2014, **PSY 2XX
DegreeRequirement.create(
	:academic_program_id => ugp.id,
	:name => 'PSY 2XX',
	:credits => 3,
...
# BA Psychology academic year 2013-2014, CJ 130/PHIL 156/ENGL 219/ENGL 220
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology academic year 2013-2014, ENGL 102
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology academic year 2013-2014, Physical and Natural Science
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology academic year 2013-2014, Fine Arts
DegreeRequirement.create(
	:academic_program_id => ugp.id,
	:name => 'Fine Arts',
	:credits => 3,
...
# BA Psychology academic year 2013-2014, Minor requirement or 2nd Major requirement
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology academic year 2013-2014, Humanities
DegreeRequirement.create(
	:academic_program_id => ugp.id,
	:name => 'Humanities',
	:credits => 3,
...
# BA Psychology academic year 2013-2014, Social Behavioral Science
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology academic year 2013-2014, PSY 302
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology academic year 2013-2014, Upper Division PSY
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology academic year 2013-2014, 2nd Major or Upper-Division Elective
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology academic year 2013-2014, Elective any level
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# BA Psychology academic year 2013-2014, Upper Division Elective
DegreeRequirement.create(
	:academic_program_id => ugp.id,
...
# Id of the BA Psychology Curriculum for academic year 2013-2014
...
# BA Psychology Term 1
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 1)

# BA Psychology Term 2
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 2)

# BA Psychology Term 3
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 3)

# BA Psychology Term 4
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 4)

# BA Psychology Term 5
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 5)

# BA Psychology Term 6
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 6)

# BA Psychology Term 7
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 7)

# BA Psychology Term 8
TermPlan.create(
	:degree_plan_id => degreeplan_id,
	:term_number => 8)
...
t1.degree_requirements << DegreeRequirement.where(:name => 'MATH 121 or MATH 129 or STAT 145', :academic_program_id => ugp.id)
t1.degree_requirements << DegreeRequirement.where(:name => 'Second Language', :academic_program_id => ugp.id)

# Term2
t2 = TermPlan.where(:degree_plan_id => degreeplan_id, :term_number => 2)[0]

t2.degree_requirements << DegreeRequirement.where(:name => 'PSY 200: Statistical Principles', :academic_program_id => ugp.id, :credits=>3)
t2.degree_requirements << DegreeRequirement.where(:name => 'PSY 2XX', :academic_program_id => ugp.id, :credits=>3)
...
t3.degree_requirements << DegreeRequirement.where(:name => 'PSY 2XX', :academic_program_id => ugp.id, :credits=>6 )
...
t5.degree_requirements << DegreeRequirement.where(:name => '2nd Major or Upper-Division Elective', :academic_program_id => ugp.id, :credits =>3)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'Upper Division PSY', :academic_program_id => ugp.id, :credits=>3)
...
# Notes for BA Psychology Degree_Plan
