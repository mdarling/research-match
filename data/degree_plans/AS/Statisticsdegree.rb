ugp = UndergradProgram.where(:name=>'Statistics', :degree => 'BS')[0]
DegreePlan.create(:undergrad_program_id => ugp.id, :academic_year=>'2013-14')

#Course:STAT 145: Introduction to Statistics Term:1
...
#Course:CS 151L: Computer Programming Fundamentals for Non-Majors Term:2
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:STAT 345: Elements of Mathematical Statistics and Probability Theory Term:3
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:MATH 314: Linear Algebra with Applications or MATH 321: Linear Algebra Term:4
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MATH 314: Linear Algebra with Applications or MATH 321: Linear Algebra',
:credits =>3,
:min_grade => 'C',
:crucial =>false)
...
#Course:STAT 427: Advanced Data Analysis I Term:5
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'STAT 427: Advanced Data Analysis I',
:credits =>3,
:min_grade => 'C',
:crucial =>false)


#Course:Enrichment Elective Term:5
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'Enrichment Elective',
:credits =>3,
:min_grade => 'C',
:crucial =>false)
...
#Course:STAT 428: Advanced Data Analysis II Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'STAT 428: Advanced Data Analysis II',
:credits =>3,
:min_grade => 'C',
:crucial =>false)
...
#Course:STAT 440: Regression Analysis Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:Stat 400+ level Elective Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'Stat 400+ level Elective',
:credits =>3,
:min_grade => 'C',
:crucial =>false)
...
#Course:STAT 445: Analysis of Variance and Experimental Design Term:8
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'STAT 445: Analysis of Variance and Experimental Design',
:credits =>3,
:min_grade => 'C',
:crucial =>false)
...
# linking Courses
# Id of Statistics Curriculum for academic year 2013-2014
degreeplan_id = DegreePlan.where(:undergrad_program_id => ugp.id, :academic_year => '2013-14')[0].id

c1 = Course.where(:number => 'STAT 145', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c1.degree_requirements << DegreeRequirement.where(:name => 'STAT 145: Introduction to Statistics', :academic_program_id => ugp.id)
...
c6 = Course.where(:number => 'CS 151L', :dept_id => Dept.where(:acronym => 'CS')[0].id)[0]
c6.degree_requirements << DegreeRequirement.where(:name => 'CS 151L: Computer Programming Fundamentals for Non-Majors', :academic_program_id => ugp.id)
...
c8.degree_requirements << DegreeRequirement.where(:name => 'STAT 345: Elements of Mathematical Statistics and Probability Theory', :academic_program_id => ugp.id)
...
c14.degree_requirements << DegreeRequirement.where(:name => 'MATH 314: Linear Algebra with Applications or MATH 321: Linear Algebra', :academic_program_id => ugp.id)

c15 = Course.where(:number => 'MATH 321', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c15.degree_requirements << DegreeRequirement.where(:name => 'MATH 314: Linear Algebra with Applications or MATH 321: Linear Algebra', :academic_program_id => ugp.id)

c17 = Course.where(:number => 'STAT 427', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c17.degree_requirements << DegreeRequirement.where(:name => 'STAT 427: Advanced Data Analysis I', :academic_program_id => ugp.id)

c19 = Course.where(:number => 'STAT 428', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c19.degree_requirements << DegreeRequirement.where(:name => 'STAT 428: Advanced Data Analysis II', :academic_program_id => ugp.id)

c21 = Course.where(:number => 'STAT 440', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c21.degree_requirements << DegreeRequirement.where(:name => 'STAT 440: Regression Analysis', :academic_program_id => ugp.id)

c26 = Course.where(:number => 'STAT 445', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c26.degree_requirements << DegreeRequirement.where(:name => 'STAT 445: Analysis of Variance and Experimental Design', :academic_program_id => ugp.id)
...
t1.degree_requirements << DegreeRequirement.where(:name => 'STAT 145: Introduction to Statistics', :academic_program_id => ugp.id,:credits=>3)
...
t2.degree_requirements << DegreeRequirement.where(:name => 'CS 151L: Computer Programming Fundamentals for Non-Majors', :academic_program_id => ugp.id,:credits=>3)
...
t3.degree_requirements << DegreeRequirement.where(:name => 'STAT 345: Elements of Mathematical Statistics and Probability Theory', :academic_program_id => ugp.id,:credits=>3)
...
t4.degree_requirements << DegreeRequirement.where(:name => 'MATH 314: Linear Algebra with Applications or MATH 321: Linear Algebra', :academic_program_id => ugp.id,:credits=>3)
...
t5.degree_requirements << DegreeRequirement.where(:name => 'STAT 427: Advanced Data Analysis I', :academic_program_id => ugp.id,:credits=>3)

t5.degree_requirements << DegreeRequirement.where(:name => 'Enrichment Elective', :academic_program_id => ugp.id,:credits=>3)
...
t6.degree_requirements << DegreeRequirement.where(:name => 'STAT 428: Advanced Data Analysis II', :academic_program_id => ugp.id,:credits=>3)

t6.degree_requirements << DegreeRequirement.where(:name => 'Enrichment Elective', :academic_program_id => ugp.id,:credits=>3)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'STAT 440: Regression Analysis', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'Minor or 2nd Major Requirement', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'Stat 400+ level Elective', :academic_program_id => ugp.id,:credits=>3)
...
t8.degree_requirements << DegreeRequirement.where(:name => 'STAT 445: Analysis of Variance and Experimental Design', :academic_program_id => ugp.id,:credits=>3)

t8.degree_requirements << DegreeRequirement.where(:name => 'Stat 400+ level Elective', :academic_program_id => ugp.id,:credits=>3)
