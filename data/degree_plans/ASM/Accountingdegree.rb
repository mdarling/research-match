ugp = UndergradProgram.where(:name=>'Accounting', :degree => 'BBA')[0]
...
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 340: Financial Accounting I',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 341: Financial Accounting II',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 343: Income Tax Accounting II',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 449: Accounting Information Systems',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
c20 = Course.where(:number => 'MGMT 340', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c20.degree_requirements << DegreeRequirement.where(:name => 'MGMT 340: Financial Accounting I', :academic_program_id => ugp.id)
...
c25 = Course.where(:number => 'MGMT 341', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c25.degree_requirements << DegreeRequirement.where(:name => 'MGMT 341: Financial Accounting II', :academic_program_id => ugp.id)

c26 = Course.where(:number => 'MGMT 346', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c26.degree_requirements << DegreeRequirement.where(:name => 'MGMT 346: Cost Accounting', :academic_program_id => ugp.id)
...
c29 = Course.where(:number => 'MGMT 343', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c29.degree_requirements << DegreeRequirement.where(:name => 'MGMT 343: Income Tax Accounting II', :academic_program_id => ugp.id)
...
c31 = Course.where(:number => 'MGMT 443', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c31.degree_requirements << DegreeRequirement.where(:name => 'MGMT 443: Auditing', :academic_program_id => ugp.id)

c32 = Course.where(:number => 'MGMT 449', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c32.degree_requirements << DegreeRequirement.where(:name => 'MGMT 449: Accounting Information Systems', :academic_program_id => ugp.id)
...
t3.degree_requirements << DegreeRequirement.where(:name => 'Computer Science 150', :academic_program_id => ugp.id,:credits=>3)
...
t5.degree_requirements << DegreeRequirement.where(:name => 'MGMT 308: Ethical, Political and Social Environment', :academic_program_id => ugp.id,:credits=>3)

t5.degree_requirements << DegreeRequirement.where(:name => 'MGMT 340: Financial Accounting I', :academic_program_id => ugp.id,:credits=>3)
...
t6.degree_requirements << DegreeRequirement.where(:name => 'MGMT 341: Financial Accounting II', :academic_program_id => ugp.id,:credits=>3)

t6.degree_requirements << DegreeRequirement.where(:name => 'MGMT 346: Cost Accounting', :academic_program_id => ugp.id,:credits=>3)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'MGMT 343: Income Tax Accounting II', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'Upper Division Humanities', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'Free Electives', :academic_program_id => ugp.id,:credits=>9)
...
t8.degree_requirements << DegreeRequirement.where(:name => 'MGMT 443: Auditing', :academic_program_id => ugp.id,:credits=>3)

t8.degree_requirements << DegreeRequirement.where(:name => 'MGMT 449: Accounting Information Systems', :academic_program_id => ugp.id,:credits=>3)
