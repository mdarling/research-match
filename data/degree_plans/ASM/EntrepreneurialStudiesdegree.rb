ugp = UndergradProgram.where(:name=>'Entrepreneurial Studies',:degree=>'BBA')[0]
...
#Course:CS 150L: Computing for Business Term:3
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:MGMT 324: New Venture Strategies Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:MGMT 384: Professional Selling Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:MGMT 495: Managing and Operating Small Growing Businesses Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 495: Managing and Operating Small Growing Businesses',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)


#Course:Entrepreneurial Studies Elective Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'Entrepreneurial Studies Elective',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
# linking Courses
# Id for Entrepreneurial Studies
# Id of Entrepreneurial Studies Curriculum for academic year 2013-2014
...
c21 = Course.where(:number => 'MGMT 308', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c21.degree_requirements << DegreeRequirement.where(:name => 'MGMT 308: Ethical Political and Social Environment', :academic_program_id => ugp.id)

c22 = Course.where(:number => 'MGMT 310', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c22.degree_requirements << DegreeRequirement.where(:name => 'MGMT 310: Legal Issues for Managers', :academic_program_id => ugp.id)

c23 = Course.where(:number => 'MGMT 324', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c23.degree_requirements << DegreeRequirement.where(:name => 'MGMT 324: New Venture Strategies', :academic_program_id => ugp.id)

c24 = Course.where(:number => 'MGMT 384', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c24.degree_requirements << DegreeRequirement.where(:name => 'MGMT 384: Professional Selling', :academic_program_id => ugp.id)

c25 = Course.where(:number => 'MGMT 497', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c25.degree_requirements << DegreeRequirement.where(:name => 'MGMT 497: Internship', :academic_program_id => ugp.id)

c26 = Course.where(:number => 'MGMT 326', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c26.degree_requirements << DegreeRequirement.where(:name => 'MGMT 326: Financial Management', :academic_program_id => ugp.id)
...
c28 = Course.where(:number => 'MGMT 495', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c28.degree_requirements << DegreeRequirement.where(:name => 'MGMT 495: Managing and Operating Small Growing Businesses', :academic_program_id => ugp.id)

c29 = Course.where(:number => 'MGMT 328', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c29.degree_requirements << DegreeRequirement.where(:name => 'MGMT 328: International Management', :academic_program_id => ugp.id)

c30 = Course.where(:number => 'MGMT 498', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c30.degree_requirements << DegreeRequirement.where(:name => 'MGMT 498: Strategic Management', :academic_program_id => ugp.id)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'MGMT 495: Managing and Operating Small Growing Businesses', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'Entrepreneurial Studies Elective', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'Upper Division Humanities', :academic_program_id => ugp.id,:credits=>3)
...
t8.degree_requirements << DegreeRequirement.where(:name => 'Entrepreneurial Studies Elective', :academic_program_id => ugp.id,:credits=>3)

t8.degree_requirements << DegreeRequirement.where(:name => 'Free Elective', :academic_program_id => ugp.id,:credits=>9)
