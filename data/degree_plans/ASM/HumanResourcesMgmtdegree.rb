ugp = UndergradProgram.where(:name=>'Human Resource Management',:degree=>'BBA')[0]
...
#Course:Physical & Natural Sciences Term:1
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:MGMT 464: Human Resources Theory and Practice Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 464: Human Resources Theory and Practice',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
#Course:MGMT 463: Employment Law Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 463: Employment Law',
:credits =>3,
:min_grade => 'C -',
:crucial =>false)


#Course:Human Resource Elective Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'Human Resource Elective',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
#Course:Human Resource Elective Term:8
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'Human Resource Elective',
:credits =>6,
:min_grade => 'C-',
...
# linking Courses
# Id for Human Resources Management
# Id of Human Resources Management Curriculum for academic year 2013-2014
...
c26 = Course.where(:number => 'STAT 245', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c26.degree_requirements << DegreeRequirement.where(:name => 'STAT 145 or STAT 245 or STAT 345', :academic_program_id => ugp.id)

c27 = Course.where(:number => 'STAT 345', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
...
c28 = Course.where(:number => 'SOC 101', :dept_id => Dept.where(:acronym => 'SOC')[0].id)[0]
c28.degree_requirements << DegreeRequirement.where(:name => 'PSY 105: General Psychology or SOC 101: Introduction to Sociology', :academic_program_id => ugp.id)
...
c29.degree_requirements << DegreeRequirement.where(:name => 'ENGL 219: Technical Writing or ENGL 220: Expository Writing', :academic_program_id => ugp.id)
...
c15 = Course.where(:number => 'MGMT 322', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c15.degree_requirements << DegreeRequirement.where(:name => 'MGMT 322: Marketing Management', :academic_program_id => ugp.id)

c16 = Course.where(:number => 'MGMT 398', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c16.degree_requirements << DegreeRequirement.where(:name => 'MGMT 398: Career Management Skills', :academic_program_id => ugp.id)

c17 = Course.where(:number => 'MGMT 308', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c17.degree_requirements << DegreeRequirement.where(:name => 'MGMT 308: Ethical, Political and Social Environment', :academic_program_id => ugp.id)

c18 = Course.where(:number => 'MGMT 310', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c18.degree_requirements << DegreeRequirement.where(:name => 'MGMT 310: Legal Issues for Managers', :academic_program_id => ugp.id)
...
c20 = Course.where(:number => 'MGMT 464', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c20.degree_requirements << DegreeRequirement.where(:name => 'MGMT 464: Human Resources Theory and Practice', :academic_program_id => ugp.id)

c21 = Course.where(:number => 'MGMT 497', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c21.degree_requirements << DegreeRequirement.where(:name => 'MGMT 497: Internship', :academic_program_id => ugp.id)
...
c23 = Course.where(:number => 'MGMT 328', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c23.degree_requirements << DegreeRequirement.where(:name => 'MGMT 328: International Management', :academic_program_id => ugp.id)

c24 = Course.where(:number => 'MGMT 463', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c24.degree_requirements << DegreeRequirement.where(:name => 'MGMT 463: Employment Law', :academic_program_id => ugp.id)
...
t1.degree_requirements << DegreeRequirement.where(:name => 'Physical & Natural Sciences', :academic_program_id => ugp.id,:credits=>3)
...
t6.degree_requirements << DegreeRequirement.where(:name => 'MGMT 464: Human Resources Theory and Practice', :academic_program_id => ugp.id,:credits=>3)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'MGMT 463: Employment Law', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'Human Resource Elective', :academic_program_id => ugp.id,:credits=>3)
...
t8.degree_requirements << DegreeRequirement.where(:name => 'Human Resource Elective', :academic_program_id => ugp.id,:credits=>6)

t8.degree_requirements << DegreeRequirement.where(:name => 'Upper Division Humanities', :academic_program_id => ugp.id,:credits=>3)

t8.degree_requirements << DegreeRequirement.where(:name => 'Free Elective', :academic_program_id => ugp.id,:credits=>3)
