ugp = UndergradProgram.where(:name=>'International Management and International Management in Latin America',:degree=>'BBA')[0]
...
#Course:MGMT 328: International Management Term:5
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:MGMT 306: Organizational Behavior and Diversity Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:MGMT 474: International Financial Management Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 474: International Financial Management',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)


#Course:International Mgmt. Elective Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'International Management Elective',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
#Course:MGMT 450: Comp. Based Info. Sys. Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:MGMT 421: Int'l Entrepreneurship Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 421: International Entrepreneurship',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)


#Course:300-Level Foreign Language Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => '300-Level Foreign Language',
:credits =>3,
:min_grade => 'C',
:crucial =>false)


#Course:Upper Division Humantiies Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'Upper Division Humantiies',
:credits =>3,
:min_grade => 'C',
:crucial =>false)
...
# linking Courses
# Id for International Management
# Id of International Management Curriculum for academic year 2013-2014
...
c12.degree_requirements << DegreeRequirement.where(:name => 'ENGL 219 OR ENGL 220', :academic_program_id => ugp.id)
...
c14 = Course.where(:number => 'MGMT 202', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c14.degree_requirements << DegreeRequirement.where(:name => 'MGMT 202: Principles of Financial Accounting', :academic_program_id => ugp.id)

c15 = Course.where(:number => 'MGMT 300', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c15.degree_requirements << DegreeRequirement.where(:name => 'MGMT 300: Operations Management', :academic_program_id => ugp.id)

c16 = Course.where(:number => 'MGMT 303', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c16.degree_requirements << DegreeRequirement.where(:name => 'MGMT 303: Manangerial Accounting', :academic_program_id => ugp.id)

c17 = Course.where(:number => 'MGMT 322', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c17.degree_requirements << DegreeRequirement.where(:name => 'MGMT 322: Marketing Management', :academic_program_id => ugp.id)

c18 = Course.where(:number => 'MGMT 326', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c18.degree_requirements << DegreeRequirement.where(:name => 'MGMT 326: Financial Management', :academic_program_id => ugp.id)

c19 = Course.where(:number => 'MGMT 328', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c19.degree_requirements << DegreeRequirement.where(:name => 'MGMT 328: International Management', :academic_program_id => ugp.id)
...
c21 = Course.where(:number => 'MGMT 306', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c21.degree_requirements << DegreeRequirement.where(:name => 'MGMT 306: Organizational Behavior and Diversity', :academic_program_id => ugp.id)

c22 = Course.where(:number => 'MGMT 308', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c22.degree_requirements << DegreeRequirement.where(:name => 'MGMT 308: Ethical Political and Social Environment', :academic_program_id => ugp.id)

c23 = Course.where(:number => 'MGMT 310', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c23.degree_requirements << DegreeRequirement.where(:name => 'MGMT 310: Legal Issues for Managers', :academic_program_id => ugp.id)

c24 = Course.where(:number => 'MGMT 474', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c24.degree_requirements << DegreeRequirement.where(:name => 'MGMT 474: International Financial Management', :academic_program_id => ugp.id)

c25 = Course.where(:number => 'MGMT 497', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c25.degree_requirements << DegreeRequirement.where(:name => 'MGMT 497: Internship (free elective)', :academic_program_id => ugp.id)

c26 = Course.where(:number => 'MGMT 450', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c26.degree_requirements << DegreeRequirement.where(:name => 'MGMT 450: Computer Based Information Systems', :academic_program_id => ugp.id)

c27 = Course.where(:number => 'MGMT 421', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c27.degree_requirements << DegreeRequirement.where(:name => 'MGMT 421: International Entrepreneurship', :academic_program_id => ugp.id)
...
t6.degree_requirements << DegreeRequirement.where(:name => 'MGMT 306: Organizational Behavior and Diversity', :academic_program_id => ugp.id,:credits=>3)
...
t6.degree_requirements << DegreeRequirement.where(:name => 'MGMT 474: International Financial Management', :academic_program_id => ugp.id,:credits=>3)

t6.degree_requirements << DegreeRequirement.where(:name => 'International Management Elective', :academic_program_id => ugp.id,:credits=>3)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'MGMT 421: International Entrepreneurship', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'International Management Elective', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => '300-Level Foreign Language', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'Upper Division Humantiies', :academic_program_id => ugp.id,:credits=>3)
...
t8.degree_requirements << DegreeRequirement.where(:name => '300-Level Foreign Language', :academic_program_id => ugp.id,:credits=>3)

t8.degree_requirements << DegreeRequirement.where(:name => 'International Management Elective', :academic_program_id => ugp.id,:credits=>3)
