ugp = UndergradProgram.where(:name=>'Marketing & Operations (Dual Concentration)', :degree => 'BBA')[0]
...
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 486: Logistics Systems Management',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 488: Materials & Supply Chain Management',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
c20 = Course.where(:number => 'MGMT 481', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c20.degree_requirements << DegreeRequirement.where(:name => 'MGMT 481: Marketing Research I', :academic_program_id => ugp.id)
...
c25 = Course.where(:number => 'MGMT 433', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c25.degree_requirements << DegreeRequirement.where(:name => 'MGMT 433: Management of Service Operations', :academic_program_id => ugp.id)

c26 = Course.where(:number => 'MGMT 486', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c26.degree_requirements << DegreeRequirement.where(:name => 'MGMT 486: Logistics Systems Management', :academic_program_id => ugp.id)
...
c31 = Course.where(:number => 'MGMT 435', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c31.degree_requirements << DegreeRequirement.where(:name => 'MGMT 435: Marketing Strategy', :academic_program_id => ugp.id)

c32 = Course.where(:number => 'MGMT 488', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c32.degree_requirements << DegreeRequirement.where(:name => 'MGMT 488: Materials & Supply Chain Management', :academic_program_id => ugp.id)
...
t6.degree_requirements << DegreeRequirement.where(:name => 'MGMT 481: Marketing Research I', :academic_program_id => ugp.id,:credits=>3)
...
t6.degree_requirements << DegreeRequirement.where(:name => 'MGMT 486: Logistics Systems Management', :academic_program_id => ugp.id,:credits=>3)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'MGMT 310: Legal Issues-Managers', :academic_program_id => ugp.id,:credits=>3)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'MGMT 434: Manufacturing Systems Management', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'MGMT 435: Marketing Strategy', :academic_program_id => ugp.id,:credits=>3)
...
t8.degree_requirements << DegreeRequirement.where(:name => 'MGMT 488: Materials & Supply Chain Management', :academic_program_id => ugp.id,:credits=>3)
...
t8.degree_requirements << DegreeRequirement.where(:name => 'Operations Elective', :academic_program_id => ugp.id,:credits=>3)
