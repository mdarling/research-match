ugp = UndergradProgram.where(:name=>'Management Information Systems',:degree=>'BBA')[0]
...
#Course:ECON 105: Introductory Macroeconomics Term:2
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:MGMT 330: Business Programming Fundamentals Term:5
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 330: Business Programming Fundamentals',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)


#Course:MGMT 459: Information Analysis Term:5
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 459: Information Analysis',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)


#Course:MGMT 308: Ethical, Political and Social Environment Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:MGMT 329: Data Management Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 329: Data Management',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
#Course:MGMT 326: Financial Management Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:Management Information System Elective Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'Management Information System Elective',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
# linking Courses
# Id for Management Information Systems
# Id of Management Information Systems Curriculum for academic year 2013-2014
...
c3.degree_requirements << DegreeRequirement.where(:name => 'MATH 180: Elements Caculus I', :academic_program_id => ugp.id)
...
c5.degree_requirements << DegreeRequirement.where(:name => 'ECON 105: Introductory Macroeconomics', :academic_program_id => ugp.id)
...
c27 = Course.where(:number => 'STAT 245', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c27.degree_requirements << DegreeRequirement.where(:name => 'STAT 145 or STAT 245 or STAT 345', :academic_program_id => ugp.id)

c28 = Course.where(:number => 'STAT 345', :dept_id => Dept.where(:acronym => 'MATH')[0].id)[0]
c28.degree_requirements << DegreeRequirement.where(:name => 'STAT 145 or STAT 245 or STAT 345', :academic_program_id => ugp.id)

c9 = Course.where(:number => 'PSY 105', :dept_id => Dept.where(:acronym => 'PSY')[0].id)[0]
c9.degree_requirements << DegreeRequirement.where(:name => 'PSY 105: General Psychology or SOC 101: Introduction to Sociology', :academic_program_id => ugp.id)

c29 = Course.where(:number => 'SOC 101', :dept_id => Dept.where(:acronym => 'SOC')[0].id)[0]
c29.degree_requirements << DegreeRequirement.where(:name => 'PSY 105: General Psychology or SOC 101: Introduction to Sociology', :academic_program_id => ugp.id)

c10 = Course.where(:number => 'ENGL 219', :dept_id => Dept.where(:acronym => 'ENGL')[0].id)[0]
c10.degree_requirements << DegreeRequirement.where(:name => 'ENGL 219: Technical Writing or ENGL 220: Expository Writing', :academic_program_id => ugp.id)

c30 = Course.where(:number => 'ENGL 220', :dept_id => Dept.where(:acronym => 'ENGL')[0].id)[0]
c30.degree_requirements << DegreeRequirement.where(:name => 'ENGL 219: Technical Writing or ENGL 220: Expository Writing', :academic_program_id => ugp.id)

c11 = Course.where(:number => 'MGMT 202', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c11.degree_requirements << DegreeRequirement.where(:name => 'MGMT 202: Principles of Financial Accounting', :academic_program_id => ugp.id)

c12 = Course.where(:number => 'MGMT 300', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c12.degree_requirements << DegreeRequirement.where(:name => 'MGMT 300: Operations Management', :academic_program_id => ugp.id)

c13 = Course.where(:number => 'MGMT 303', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c13.degree_requirements << DegreeRequirement.where(:name => 'MGMT 303: Managerial Accounting', :academic_program_id => ugp.id)

c14 = Course.where(:number => 'MGMT 306', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c14.degree_requirements << DegreeRequirement.where(:name => 'MGMT 306: Organizational Behavior and Diversity', :academic_program_id => ugp.id)

c15 = Course.where(:number => 'MGMT 398', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c15.degree_requirements << DegreeRequirement.where(:name => 'MGMT 398: Career Management Skills', :academic_program_id => ugp.id)

c16 = Course.where(:number => 'MGMT 330', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c16.degree_requirements << DegreeRequirement.where(:name => 'MGMT 330: Business Programming Fundamentals', :academic_program_id => ugp.id)

c17 = Course.where(:number => 'MGMT 459', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c17.degree_requirements << DegreeRequirement.where(:name => 'MGMT 459: Information Analysis', :academic_program_id => ugp.id)

c18 = Course.where(:number => 'MGMT 308', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c18.degree_requirements << DegreeRequirement.where(:name => 'MGMT 308: Ethical, Political and Social Environment', :academic_program_id => ugp.id)

c19 = Course.where(:number => 'MGMT 310', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c19.degree_requirements << DegreeRequirement.where(:name => 'MGMT 310: Legal Issues for Managers', :academic_program_id => ugp.id)

c20 = Course.where(:number => 'MGMT 322', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c20.degree_requirements << DegreeRequirement.where(:name => 'MGMT 322: Marketing Management', :academic_program_id => ugp.id)

c21 = Course.where(:number => 'MGMT 329', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c21.degree_requirements << DegreeRequirement.where(:name => 'MGMT 329: Data Management', :academic_program_id => ugp.id)

c22 = Course.where(:number => 'MGMT 497', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c22.degree_requirements << DegreeRequirement.where(:name => 'MGMT 497: Internship', :academic_program_id => ugp.id)

c23 = Course.where(:number => 'MGMT 326', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c23.degree_requirements << DegreeRequirement.where(:name => 'MGMT 326: Financial Management', :academic_program_id => ugp.id)

c24 = Course.where(:number => 'MGMT 450', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c24.degree_requirements << DegreeRequirement.where(:name => 'MGMT 450: Computer-Based Information Systems', :academic_program_id => ugp.id)

c25 = Course.where(:number => 'MGMT 498', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c25.degree_requirements << DegreeRequirement.where(:name => 'MGMT 498: Strategic Management ', :academic_program_id => ugp.id)
...
t2.degree_requirements << DegreeRequirement.where(:name => 'ECON 105: Introductory Macroeconomics', :academic_program_id => ugp.id,:credits=>3)
...
t5.degree_requirements << DegreeRequirement.where(:name => 'MGMT 330: Business Programming Fundamentals', :academic_program_id => ugp.id,:credits=>3)

t5.degree_requirements << DegreeRequirement.where(:name => 'MGMT 459: Information Analysis', :academic_program_id => ugp.id,:credits=>3)

# Term 6

t6 = TermPlan.where(:degree_plan_id => degreeplan_id, :term_number =>6)[0]

t6.degree_requirements << DegreeRequirement.where(:name => 'MGMT 308: Ethical, Political and Social Environment', :academic_program_id => ugp.id,:credits=>3)
...
t6.degree_requirements << DegreeRequirement.where(:name => 'MGMT 329: Data Management', :academic_program_id => ugp.id,:credits=>3)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'MGMT 326: Financial Management', :academic_program_id => ugp.id,:credits=>3)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'Management Information System Elective', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'Free elective', :academic_program_id => ugp.id,:credits=>9)
...
t8.degree_requirements << DegreeRequirement.where(:name => 'MGMT 328: International Management', :academic_program_id => ugp.id,:credits=>3)

t8.degree_requirements << DegreeRequirement.where(:name => 'Management Information System Elective', :academic_program_id => ugp.id,:credits=>3)
