ugp = UndergradProgram.where(:name=>'Organizational Leadership', :degree => 'BBA')[0]
...
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 362: Leadership Development',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
#Course:MGMT 443: Auditing Term:8
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'Organizational Leadership Elective',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
#Course:MGMT 498: Strategic Management Term:8
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 307: Organizational Change and Innovation',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
#Course:MGMT 498: Strategic Management Term:8
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'MGMT 458: Managerial Ethics',
:credits =>3,
:min_grade => 'C-',
:crucial =>false)
...
c29 = Course.where(:number => 'MGMT 362', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c29.degree_requirements << DegreeRequirement.where(:name => 'MGMT 362: Leadership Development', :academic_program_id => ugp.id)
...
c31 = Course.where(:number => 'MGMT 307', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c31.degree_requirements << DegreeRequirement.where(:name => 'MGMT 307: Organizational Change and Innovation', :academic_program_id => ugp.id)

c32 = Course.where(:number => 'MGMT 458', :dept_id => Dept.where(:acronym => 'ASM')[0].id)[0]
c32.degree_requirements << DegreeRequirement.where(:name => 'MGMT 458: Managerial Ethics', :academic_program_id => ugp.id)
...
t6.degree_requirements << DegreeRequirement.where(:name => 'MGMT 362: Leadership Development', :academic_program_id => ugp.id,:credits=>3)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'MGMT 307: Organizational Change and Innovation', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'MGMT 458: Managerial Ethics', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'Organizational Leadership Elective', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'Free Elective', :academic_program_id => ugp.id,:credits=>6)

# Term 8MGMT 450: Computer-Based Information Systems

t8 = TermPlan.where(:degree_plan_id => degreeplan_id, :term_number =>8)[0]

t8.degree_requirements << DegreeRequirement.where(:name => 'MGMT 450: Computer-Based Information Systems', :academic_program_id => ugp.id,:credits=>3)

t8.degree_requirements << DegreeRequirement.where(:name => 'MGMT 498: Strategic Management', :academic_program_id => ugp.id,:credits=>3)

t8.degree_requirements << DegreeRequirement.where(:name => 'Organizational Leadership Elective', :academic_program_id => ugp.id,:credits=>3)
