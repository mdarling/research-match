ugp = UndergradProgram.where(:name=>'Art Studio', :degree => 'BA')[0]
...
#Course:HIST 102: Western Civilization Post 1648 Term:2
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:Elective in Any Field Term:2
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:Physical/Natural Science Term:3
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:ARTS 130 OR ARTS141 OR ARTS 157 OR ARTS 168 OR ARTS 187 OR ARTS 207 OR ARTS 213 OR ARTS 274 Term:3
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'ARTS 130 OR ARTS 141 OR ARTS 157 OR ARTS 168 OR ARTS 187 OR ARTS 207 OR ARTS 213 OR ARTS 274',
:credits =>3,
:min_grade => 'D-',
...
#Course:ARTH 201 OR ARTS 202 OR ARTS 250 Term:3
DegreeRequirement.create(:academic_program_id => ugp.id,
:name => 'ARTH 201 OR ARTS 202 OR ARTS 250',
:credits =>3,
:min_grade => 'D-',
:crucial =>false)
...
#Course:Elective Outside the Major Dept Term:4
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:Foreign Language Term:4
DegreeRequirement.create(:academic_program_id => ugp.id,
...
c4 = Course.where(:number => 'ARTS 125', :dept_id => Dept.where(:acronym => 'ARTH')[0].id)[0]
c4.degree_requirements << DegreeRequirement.where(:name => 'ARTS 125: Art Practices I', :academic_program_id => ugp.id)
...
c7 = Course.where(:number => 'ARTS 126', :dept_id => Dept.where(:acronym => 'ARTH')[0].id)[0]
c7.degree_requirements << DegreeRequirement.where(:name => 'ARTS 126: Art Practices II', :academic_program_id => ugp.id)

c8 = Course.where(:number => 'ARTS 130', :dept_id => Dept.where(:acronym => 'ARTH')[0].id)[0]
c8.degree_requirements << DegreeRequirement.where(:name => 'ARTS 130 OR ARTS 141 OR ARTS 157 OR ARTS 168 OR ARTS 187 OR ARTS 207 OR ARTS 213 OR ARTS 274ARTS 130 OR ARTS141 OR ARTS 157 OR ARTS 168 OR ARTS 187 OR ARTS 207 OR ARTS 213 OR ARTS 274', :academic_program_id => ugp.id)

c9 = Course.where(:number => 'ARTS 141', :dept_id => Dept.where(:acronym => 'ARTH')[0].id)[0]
...
c10 = Course.where(:number => 'ARTS 157', :dept_id => Dept.where(:acronym => 'ARTH')[0].id)[0]
...
c11 = Course.where(:number => 'ARTS 168', :dept_id => Dept.where(:acronym => 'ARTH')[0].id)[0]
...
c12 = Course.where(:number => 'ARTS 187', :dept_id => Dept.where(:acronym => 'ARTH')[0].id)[0]
...
c13 = Course.where(:number => 'ARTS 207', :dept_id => Dept.where(:acronym => 'ARTH')[0].id)[0]
...
c14 = Course.where(:number => 'ARTS 213', :dept_id => Dept.where(:acronym => 'ARTH')[0].id)[0]
c14.degree_requirements << DegreeRequirement.where(:name => 'ARTS 130 OR ARTS 141 OR ARTS 157 OR ARTS 168 OR ARTS 187 OR ARTS 207 OR ARTS 213 OR ARTS 274', :academic_program_id => ugp.id)

c15 = Course.where(:number => 'ARTS 274', :dept_id => Dept.where(:acronym => 'ARTH')[0].id)[0]
c15.degree_requirements << DegreeRequirement.where(:name => 'ARTS 130 OR ARTS 141 OR ARTS 157 OR ARTS 168 OR ARTS 187 OR ARTS 207 OR ARTS 213 OR ARTS 274', :academic_program_id => ugp.id)

c16 = Course.where(:number => 'ENGL 220', :dept_id => Dept.where(:acronym => 'ENGL')[0].id)[0]
c16.degree_requirements << DegreeRequirement.where(:name => 'ENGL 220: Expository Writing', :academic_program_id => ugp.id)


c25 = Course.where(:number => 'ARTH 201', :dept_id => Dept.where(:acronym => 'ARTH')[0].id)[0]
c25.degree_requirements << DegreeRequirement.where(:name => 'ARTH 201 OR ARTS 202 OR ARTS 250', :academic_program_id => ugp.id)

c26 = Course.where(:number => 'ARTH 202', :dept_id => Dept.where(:acronym => 'ARTH')[0].id)[0]
c26.degree_requirements << DegreeRequirement.where(:name => 'ARTH 201 OR ARTS 202 OR ARTS 250', :academic_program_id => ugp.id)

c27 = Course.where(:number => 'ARTH 250', :dept_id => Dept.where(:acronym => 'ARTH')[0].id)[0]
c27.degree_requirements << DegreeRequirement.where(:name => 'ARTH 201 OR ARTS 202 OR ARTS 250', :academic_program_id => ugp.id)
...
t2.degree_requirements << DegreeRequirement.where(:name => 'Elective in Any Field', :academic_program_id => ugp.id,:credits=>3)
...
t3.degree_requirements << DegreeRequirement.where(:name => 'Physical/Natural Science', :academic_program_id => ugp.id,:credits=>4)

t3.degree_requirements << DegreeRequirement.where(:name => 'ARTS 130 OR ARTS141 OR ARTS 157 OR ARTS 168 OR ARTS 187 OR ARTS 207 OR ARTS 213 OR ARTS 274', :academic_program_id => ugp.id,:credits=>3)

t3.degree_requirements << DegreeRequirement.where(:name => 'ARTS Elective', :academic_program_id => ugp.id,:credits=>3)

t3.degree_requirements << DegreeRequirement.where(:name => 'ARTH 201 OR ARTS 202 OR ARTS 250', :academic_program_id => ugp.id,:credits=>3)
...
t4.degree_requirements << DegreeRequirement.where(:name => 'Elective Outside the Major Dept', :academic_program_id => ugp.id,:credits=>3)

t4.degree_requirements << DegreeRequirement.where(:name => 'Elective in Any Field', :academic_program_id => ugp.id,:credits=>6)

t4.degree_requirements << DegreeRequirement.where(:name => 'Foreign Language', :academic_program_id => ugp.id,:credits=>3)
