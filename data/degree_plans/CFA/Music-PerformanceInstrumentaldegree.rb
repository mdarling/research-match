ugp = UndergradProgram.where(:name=>'Music (Performance Concentration, with Instrumental Emphasis)',:degree=>'BM')[0]
...
#Course:APMS 301: principal instrument Term:5
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:Chamber Ensemble Term:5
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:APMS 302: principal instrument Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:MUS 309 OR 325 OR 405 OR 406 OR 439 Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:MUS 417 OR MUS 418 OR MUS 422 OR MUS 436 OR MUS 444 OR MUS 448 OR MUS 293 Term:6
DegreeRequirement.create(:academic_program_id => ugp.id,
...
#Course:Music elective (not Non-Major course) Term:7
DegreeRequirement.create(:academic_program_id => ugp.id,
...
# linking Courses
# Id for Performance Instrumental
# Id of Performance Instrumental Curriculum for academic year 2013-2014
...
c5.degree_requirements << DegreeRequirement.where(:name => 'MUS 111: Group Piano', :academic_program_id => ugp.id)
...
c7 = Course.where(:number => 'APMS 102', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c7.degree_requirements << DegreeRequirement.where(:name => 'APMS 102: Studio Instruction for the Performance Concentration', :academic_program_id => ugp.id)

c8 = Course.where(:number => 'MUS 152', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c8.degree_requirements << DegreeRequirement.where(:name => 'MUS 152: Music Theory II', :academic_program_id => ugp.id)

c9 = Course.where(:number => 'MUS 152L', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c9.degree_requirements << DegreeRequirement.where(:name => 'MUS 152L: Music Theory II Aural Lab', :academic_program_id => ugp.id)

c10 = Course.where(:number => 'MUS 112', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c10.degree_requirements << DegreeRequirement.where(:name => 'MUS 112: Group Piano II', :academic_program_id => ugp.id)
...
c14.degree_requirements << DegreeRequirement.where(:name => 'MUS 250L: Music Theory III Aural Lab ', :academic_program_id => ugp.id)

c15 = Course.where(:number => 'MUS 211', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c15.degree_requirements << DegreeRequirement.where(:name => 'MUS 211: Group Piano III', :academic_program_id => ugp.id)

c16 = Course.where(:number => 'HIST 101', :dept_id => Dept.where(:acronym => 'HIST')[0].id)[0]
c16.degree_requirements << DegreeRequirement.where(:name => 'HIST 101: Western Civilization to 1648', :academic_program_id => ugp.id)
...
c18 = Course.where(:number => 'MUS 252', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c18.degree_requirements << DegreeRequirement.where(:name => 'MUS 252: Music Theory IV', :academic_program_id => ugp.id)

c19 = Course.where(:number => 'MUS 252L', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c19.degree_requirements << DegreeRequirement.where(:name => 'MUS 252L: Music Theory IV Aural Lab', :academic_program_id => ugp.id)

c20 = Course.where(:number => 'MUS 212', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c20.degree_requirements << DegreeRequirement.where(:name => 'MUS 212: Group Piano IV', :academic_program_id => ugp.id)

c21 = Course.where(:number => 'MUS 214', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c21.degree_requirements << DegreeRequirement.where(:name => 'MUS 214: Piano Proficiency', :academic_program_id => ugp.id)

c22 = Course.where(:number => 'ENGL 220', :dept_id => Dept.where(:acronym => 'ENGL')[0].id)[0]
c22.degree_requirements << DegreeRequirement.where(:name => 'ENGL 220: Expository Writing', :academic_program_id => ugp.id)

c23 = Course.where(:number => 'HIST 102', :dept_id => Dept.where(:acronym => 'HIST')[0].id)[0]
c23.degree_requirements << DegreeRequirement.where(:name => 'HIST 102: Western Civilization Post 1648', :academic_program_id => ugp.id)

c24 = Course.where(:number => 'APMS 301', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c24.degree_requirements << DegreeRequirement.where(:name => 'APMS 301: Studio Instruction for the Performance Concentration', :academic_program_id => ugp.id)

c25 = Course.where(:number => 'MUS 453', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c25.degree_requirements << DegreeRequirement.where(:name => 'MUS 453: Orchestration', :academic_program_id => ugp.id)

c26 = Course.where(:number => 'MUS 361', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c26.degree_requirements << DegreeRequirement.where(:name => 'MUS 361: History of Music I', :academic_program_id => ugp.id)

c27 = Course.where(:number => 'MUS 363', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c27.degree_requirements << DegreeRequirement.where(:name => 'MUS 363: Conducting', :academic_program_id => ugp.id)
...
c33 = Course.where(:number => 'APMS 302', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c33.degree_requirements << DegreeRequirement.where(:name => 'APMS 302: Studio Instruction for the Performance Concentration', :academic_program_id => ugp.id)

c34 = Course.where(:number => 'APMS 391', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c34.degree_requirements << DegreeRequirement.where(:name => 'APMS 391: Junior Recital', :academic_program_id => ugp.id)

c35 = Course.where(:number => 'MUS 309', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c35.degree_requirements << DegreeRequirement.where(:name => 'MUS 309 OR MUS 325 OR MUS 405 OR MUS 406 OR MUS 439', :academic_program_id => ugp.id)

c36 = Course.where(:number => 'MUS 325', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
...
c37 = Course.where(:number => 'MUS 405', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
...
c38 = Course.where(:number => 'MUS 406', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c38.degree_requirements << DegreeRequirement.where(:name => 'MUS 309 OR MUS 325 OR MUS 405 OR MUS 406 OR MUS 439', :academic_program_id => ugp.id)

c39 = Course.where(:number => 'MUS 439', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
...
c41 = Course.where(:number => 'MUS 417', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c41.degree_requirements << DegreeRequirement.where(:name => 'MUS 417 OR MUS 418 OR MUS 422 OR MUS 436 OR MUS 444 OR MUS 448 OR MUSE 293', :academic_program_id => ugp.id)

c42 = Course.where(:number => 'MUS 418', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c42.degree_requirements << DegreeRequirement.where(:name => 'MUS 417 OR MUS 418 OR MUS 422 OR MUS 436 OR MUS 444 OR MUS 448 OR MUSE 293', :academic_program_id => ugp.id)

c43 = Course.where(:number => 'MUS 422', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c43.degree_requirements << DegreeRequirement.where(:name => 'MUS 417 OR MUS 418 OR MUS 422 OR MUS 436 OR MUS 444 OR MUS 448 OR MUSE 293', :academic_program_id => ugp.id)

c44 = Course.where(:number => 'MUS 436', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c44.degree_requirements << DegreeRequirement.where(:name => 'MUS 417 OR MUS 418 OR MUS 422 OR MUS 436 OR MUS 444 OR MUS 448 OR MUSE 293', :academic_program_id => ugp.id)

c45 = Course.where(:number => 'MUS 444', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c45.degree_requirements << DegreeRequirement.where(:name => 'MUS 417 OR MUS 418 OR MUS 422 OR MUS 436 OR MUS 444 OR MUS 448 OR MUSE 293', :academic_program_id => ugp.id)

c46 = Course.where(:number => 'MUS 448', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
...
c47 = Course.where(:number => 'MUSE 293', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
...
c48 = Course.where(:number => 'APMS 401', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c48.degree_requirements << DegreeRequirement.where(:name => 'APMS 401: Studio Instruction for the Performance Concentration', :academic_program_id => ugp.id)

c49 = Course.where(:number => 'MUS 413', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
...
c50 = Course.where(:number => 'MUS 414', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
...
c51 = Course.where(:number => 'MUS 415', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c51.degree_requirements << DegreeRequirement.where(:name => 'MUS 413 OR MUS 414 OR MUS 415 OR MUS 416 OR MUS 437', :academic_program_id => ugp.id)

c52 = Course.where(:number => 'MUS 416', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c52.degree_requirements << DegreeRequirement.where(:name => 'MUS 413 OR MUS 414 OR MUS 415 OR MUS 416 OR MUS 437', :academic_program_id => ugp.id)

c53 = Course.where(:number => 'MUS 437', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c53.degree_requirements << DegreeRequirement.where(:name => 'MUS 413 OR MUS 414 OR MUS 415 OR MUS 416 OR MUS 437', :academic_program_id => ugp.id)

c54 = Course.where(:number => 'APMS 402', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c54.degree_requirements << DegreeRequirement.where(:name => 'APMS 402: Studio Instruction for the Performance Concentration', :academic_program_id => ugp.id)

c55 = Course.where(:number => 'APMS 491', :dept_id => Dept.where(:acronym => 'MUS')[0].id)[0]
c55.degree_requirements << DegreeRequirement.where(:name => 'APMS 491: Senior Recital', :academic_program_id => ugp.id)
...
t5.degree_requirements << DegreeRequirement.where(:name => 'Chamber Ensemble', :academic_program_id => ugp.id,:credits=>1)
...
t6.degree_requirements << DegreeRequirement.where(:name => 'MUS 417 OR MUS 418 OR MUS 422 OR MUS 436 OR MUS 444 OR MUS 448 OR MUSE 293', :academic_program_id => ugp.id,:credits=>3)

t6.degree_requirements << DegreeRequirement.where(:name => 'Major Ensemble', :academic_program_id => ugp.id,:credits=>1)

t6.degree_requirements << DegreeRequirement.where(:name => 'Music elective (not Non-Major course)', :academic_program_id => ugp.id,:credits=>1)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'Music Theory', :academic_program_id => ugp.id,:credits=>2)
...
t7.degree_requirements << DegreeRequirement.where(:name => 'Chamber Music', :academic_program_id => ugp.id,:credits=>1)

t7.degree_requirements << DegreeRequirement.where(:name => 'Music elective (not Non-Major course)', :academic_program_id => ugp.id,:credits=>3)

t7.degree_requirements << DegreeRequirement.where(:name => 'Music elective (not Non-Major course)', :academic_program_id => ugp.id,:credits=>1)
...
t8.degree_requirements << DegreeRequirement.where(:name => 'Music elective (not Non-Major course)', :academic_program_id => ugp.id,:credits=>3)

t8.degree_requirements << DegreeRequirement.where(:name => 'Fine Arts outside the major', :academic_program_id => ugp.id,:credits=>3)

t8.degree_requirements << DegreeRequirement.where(:name => 'Elective outside the major department', :academic_program_id => ugp.id,:credits=>6)
